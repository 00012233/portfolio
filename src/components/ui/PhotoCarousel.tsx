...
export default function PhotoCarousel({
        ...
        <div className="text-center text-text-muted">
          ...
          >
            <path
              ...
              strokeWidth={1.5}
              d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0L21 15.75M3.75 21h16.5A2.25 2.25 0 0022.5 18.75V5.25A2.25 2.25 0 0020.25 3H3.75A2.25 2.25 0 001.5 5.25v13.5A2.25 2.25 0 003.75 21z"
            />
          </svg>
          <p className="text-sm">添加照片</p>
          <p className="text-xs opacity-60 mt-1">Add photos here</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div
      className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden bg-secondary group"
        ...
        <>
          <button
            ...
            className="absolute left-3 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full
                       bg-white/70 backdrop-blur-sm text-text-primary flex items-center justify-center
